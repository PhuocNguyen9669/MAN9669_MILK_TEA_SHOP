    ...
    public static double retryParseDouble(){
        ...
        do {
            ...
            try {
                ...
                System.out.println("Nhập lại! Vui lòng nhập lại");
            }
        } while (true);
    }
        ...
        do {
            switch (inputOption){
                case ADD:
                    ...
                    break;
                case UPDATE:
                    System.out.println("Nhấn 'y' sửa thêm tiếp \t|\t 'q' để quay lại \t|\t 't' để thoát chương trình");
                    break;
                case DELETE:
                ...
                case SHOW:
                    ...
                    break;
                default:
                    throw new IllegalStateException("Unchecked value: "+ inputOption);
            }
            System.out.print(" ⭆ ");
